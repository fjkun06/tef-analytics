...
export default {
  ...
  home: {
    domains: {
      experience: {
        ...
        subtitle: "Science des données & ML",
      },
      projects: {
  ...
  imprint: {
    ...
    accordingTo: "Conformément à l'article 5 de la TMG",
    country: "Allemagne",
    contactInformation: "Informations de contact",
    professionalInformation: "Informations professionnelles",
    liabilityForContent: "Responsabilité du contenu",
