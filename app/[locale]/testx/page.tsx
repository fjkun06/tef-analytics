  ...
  return (
    <div className="bg-gray-900">
      ...
      <div className="flex w-full justify-center p-8">
        <div className="flex h-8 w-4 bg-green-500 mask-[url(/star.svg),url(/star.svg)),url(/star.svg)),url(/star.svg)),url(/star.svg))]"></div>
        {/* <div className="flex h-max w-max bg-red-500">
          <svg
